...
- [ADR-0042](adr/0042-status-draws-the-neighbourhood.md) — `status` draws the neighbourhood: previous phase, current phase boxed, next phases one row each, from a `phase_entered_from` stamped beside `phase_entered_at` *(amends 0031)*
