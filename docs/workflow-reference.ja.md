...
静かに終わる 6 つの理由のうち、呼び出し側が*自分について*答えられる唯一のものでもあります。
解決すべき識別子が無いからです。
...
ターンが静かに終わる理由は 6 つあり、それらを見分けるために見る場所は、理由ごとに違います。
6 つのうち 1 つは新顔で、他の 5 つと違い、2 度目の探索(前述)が最初の探索の取りこぼしを見つけたときにだけ生まれます。
...
7 つ目の道はこの表にありません。見るべきものが無いからです。
...
**`driver:` は 5 行目を絞り込むだけで、決着はつけません。**
